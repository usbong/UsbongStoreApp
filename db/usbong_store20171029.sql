...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 29, 2017 at 10:45 AM
...
(3, 'Usbong', 'Mart', 'support@usbong.ph', '$2y$10$vih.EI8gsPHoYKesOxXimO.nVTEoNYRRzfa6jqyNa4CbTfg2/jlEW', 7894561, '2 E. Rodriguez Ave. Sto. Niño', 'Marikina City', 'Philippines', 1800, 2, 1, 4),
(4, 'M', 'S', 'learn@usbong.ph', '$2y$10$xqixUcO58M71QM4.eG.bvOkebw/gj/LOR7VbBrsdNyDFNQ/I2KSqC', 1234567, '2 E. Rodriguez Ave. Sto. Niño', 'Marikina City', 'Philippines', 1800, 2, 0, 0);
...
CREATE TABLE `customer_request` (
  ...
  `fulfilled_status` tinyint(4) NOT NULL DEFAULT '0',
  `fulfilled_datetime_stamp` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 1, '2017-10-29 10:21:35', 'hello', 'http://nature.usbong.ph', 0, 1, 50, 'Thank you.', '2017-10-29 10:21:35', 0),
(2, 1, '2017-10-29 10:39:22', 'hullo', 'http://fish.usbong.ph', 0, 1, 0, 'Thank you.', '2017-10-29 10:39:22', 0),
(3, 1, '2017-10-29 10:53:28', 'Hi', 'http://filipino.usbong.ph', 0, 1, 0, 'Thank you.', '2017-10-29 10:53:28', 0),
(4, 1, '2017-10-29 10:54:03', 'hey', 'hey', 0, 2, 100, 'Thank you.', '2017-10-29 10:54:03', 0),
(5, 1, '2017-10-29 10:55:30', 'ho', 'ho', 0, 1, 0, 'Thank you.', '2017-10-29 10:55:30', 0),
(6, 1, '2017-10-29 10:56:51', 'yay', 'yay', 0, 1, 0, 'Thank you.', '2017-10-29 10:56:51', 0),
(7, 1, '2017-10-29 14:39:07', 'hi', 'hi', 0, 1, 0, 'Thank you.', '2017-10-29 14:39:07', 0),
(8, 1, '2017-10-29 16:38:26', 'gut', 'gut', 0, 1, 0, 'Thank you.', '2017-10-29 16:38:26', 0),
(9, 1, '2017-10-29 17:10:34', 'a', 'a', 0, 1, 0, 'Thank you.', '2017-10-29 17:10:34', 0);
...
(114, 1, 2, 'The Alchemist', 350, NULL, 'English', 'Paulo Coelho', NULL, 'Used - Acceptable', NULL, 'Paperback', 1, NULL, '\"When a person really desires something, all the universe conspires to help that person to realize his dream...\" ', NULL, 0),
...
(210, 1, 2, 'Made to Stick', 550, NULL, 'English', 'Chip Heath/Dan Heath', NULL, 'Used - Good', NULL, 'Paperback', 2, NULL, NULL, NULL, 0),
...
(1, -1, 'popsicle', '2017-09-15 17:04:59'),
(2, -1, 'japan', '2017-09-15 17:05:28'),
(3, -1, 'popsicle', '2017-09-15 17:05:58'),
(4, -1, 'popsicle', '2017-09-15 19:48:43'),
(5, -1, 'wooden', '2017-09-26 17:02:31'),
(6, -1, 'wooden', '2017-10-07 16:52:48'),
(7, -1, 'wooden', '2017-10-07 16:52:55'),
(8, -1, 'wooden', '2017-10-07 16:53:02'),
(9, -1, 'wooden', '2017-10-07 16:53:21'),
(10, -1, 'wooden', '2017-10-07 17:00:57'),
(11, -1, 'wooden', '2017-10-07 17:01:09'),
(12, -1, 'wooden', '2017-10-07 17:01:20'),
(13, -1, 'tea', '2017-10-07 17:01:23'),
(14, -1, 'wooden', '2017-10-07 17:01:28'),
(15, -1, 'wooden', '2017-10-07 17:02:11'),
(16, -1, 'tea', '2017-10-07 17:02:16'),
(17, 1, 'wooden', '2017-10-08 16:10:38'),
(18, 1, 'genki', '2017-10-08 16:12:57'),
(19, -1, 'dilbert', '2017-10-09 19:32:03'),
(20, 3, 'made to stick', '2017-10-11 20:36:37'),
(21, -1, 'stick', '2017-10-12 08:05:16'),
(22, 3, 'stick', '2017-10-12 08:05:28'),
(23, 3, 'stick', '2017-10-12 12:49:13'),
(24, -1, 'peace', '2017-10-12 17:02:24'),
(25, -1, 'community', '2017-10-12 17:02:30');
...
--
ALTER TABLE `customer_request`
  MODIFY `customer_request_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `customer_sell`
--
ALTER TABLE `customer_sell`
  MODIFY `customer_sell_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `product`
  MODIFY `product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=312;
--
...
--
ALTER TABLE `search`
  MODIFY `search_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
--
