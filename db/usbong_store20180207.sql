...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 07, 2018 at 02:36 AM
...
(1, 'abc', 'def', 'usbong.ph@gmail.com', '$2y$10$sJ172qJOmDLBy60.nhp81OoDBQzSmi/aHcvJxJSQh5IJfx844Ec6i', '1234567', '2 E. Rodriguez Ave. Sto. Niño', 'Marikina City', 'Philippines', 1800, 0, 1, 0, '2018-02-04 09:49:49', '2018-02-04 09:49:32'),
...
(5, 'A', 'Z', 'learn@usbong.ph', '$2y$10$OHtrmYEeLXs5npFy5oBXue4YxA.PN3bLSHBMYaPy67h04w9hIDaoG', NULL, NULL, NULL, NULL, NULL, 0, 0, 1, '2018-02-04 09:49:37', '2018-02-04 09:49:44'),
...
--
ALTER TABLE `contact_case`
  MODIFY `contact_case_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `product`
  MODIFY `product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=430;
--
...
--
ALTER TABLE `search`
  MODIFY `search_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
--
