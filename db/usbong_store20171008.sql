...
(3, 'Usbong', 'Mart', 'support@usbong.ph', '$2y$10$vih.EI8gsPHoYKesOxXimO.nVTEoNYRRzfa6jqyNa4CbTfg2/jlEW', 1234567, '2 E. Rodriguez Ave. Sto. Niño', 'Marikina City', 'Philippines', 1800, 2, 1, 4);
...
--
ALTER TABLE `product`
  MODIFY `product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=278;
--
