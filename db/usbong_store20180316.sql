...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 16, 2018 at 02:35 AM
...
(44, 433, 1, NULL, 1, 700, '2018-02-25 19:55:32', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0),
(45, 235, 1, NULL, 1, 500, '2018-02-25 19:56:58', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0),
(46, 116, 1, NULL, 1, 400, '2018-02-25 20:00:22', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0);
...
(1, 'abc', 'def', 'usbong.ph@gmail.com', '$2y$10$sJ172qJOmDLBy60.nhp81OoDBQzSmi/aHcvJxJSQh5IJfx844Ec6i', '1234567', '2 E. Rodriguez Ave. Sto. Niño', 'Marikina City', 'Philippines', 1800, 0, 1, 0, '2018-03-13 16:21:18', '2018-02-13 15:41:27'),
...
(5, 'A', 'Z', 'learn@usbong.ph', '$2y$10$OHtrmYEeLXs5npFy5oBXue4YxA.PN3bLSHBMYaPy67h04w9hIDaoG', NULL, NULL, NULL, NULL, NULL, 0, 0, 1, '2018-03-03 08:40:27', '2018-02-13 15:29:14'),
...
(34, 1, 5, 'PROMO-Starting Point, Turning Point', 2180, NULL, 'English', 'Hayao Miyazaki', NULL, 'New', NULL, 'Mixed', 1, 'Beth Cary and Frederik L. Schodt', NULL, NULL, 30, 0, NULL, 1),
...
(233, 1, 2, 'A Brief History of Time', 500, NULL, 'English', 'Stephen Hawking', NULL, 'Used - Good', NULL, 'Paperback', 1, NULL, NULL, NULL, 63, 0, NULL, 1),
...
(380, 1, 2, 'A Farewell to Arms', 320, NULL, 'English', 'Ernest Hemingway', NULL, 'Used - Acceptable', NULL, 'Paperback', 1, NULL, NULL, NULL, 32, 0, NULL, 1),
...
(409, 1, 9, '2008-2010 English Reading', 450, NULL, 'English/Mandarin (Traditional)', 'nie qun, et al.', NULL, 'Used - Acceptable', NULL, 'Paperback', 0, NULL, NULL, NULL, 22, 0, NULL, 1),
...
(466, 1, 2, 'The Deming Management Method', 225, NULL, 'English', 'Mary Walton', NULL, 'Used - Very Good', NULL, 'Paperback', 99, NULL, NULL, NULL, 0, 0, NULL, 1),
...
(472, 1, 2, 'ABNKKBSNPLAKO', 170, NULL, 'Filipino', 'Bob Ong', NULL, 'Used - Good', NULL, 'Paperback', 1, NULL, NULL, NULL, 0, 0, NULL, 1),
...
(6, 'Comics', 207),
(7, 'Manga', 158),
(8, 'Toys & Collectibles', 214),
(9, 'Textbooks', 204),
(10, 'Children\'s', 491),
(11, 'Food', 256),
(12, 'Miscellaneous', 203),
(13, 'Medical', 49);
...
--
ALTER TABLE `customer_order`
  MODIFY `customer_order_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
...
--
ALTER TABLE `product`
  MODIFY `product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=481;
--
...
--
ALTER TABLE `search`
  MODIFY `search_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
--
