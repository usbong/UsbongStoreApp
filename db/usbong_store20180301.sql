...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 01, 2018 at 06:57 AM
...
(1, 'abc', 'def', 'usbong.ph@gmail.com', '$2y$10$sJ172qJOmDLBy60.nhp81OoDBQzSmi/aHcvJxJSQh5IJfx844Ec6i', '1234567', '2 E. Rodriguez Ave. Sto. Niño', 'Marikina City', 'Philippines', 1800, 0, 1, 0, '2018-02-26 12:56:34', '2018-02-13 15:41:27'),
...
(235, 1, 2, 'A Brief History of Time', 500, NULL, 'English', 'Stephen Hawking', NULL, 'Used - Good', NULL, 'Paperback', 1, NULL, NULL, NULL, 2, 1, NULL, 1),
...
(382, 1, 2, 'A Farewell to Arms', 320, NULL, 'English', 'Ernest Hemingway', NULL, 'Used - Acceptable', NULL, 'Paperback', 1, NULL, NULL, NULL, 0, 0, NULL, 1),
...
--
ALTER TABLE `product`
  MODIFY `product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=448;
--
...
--
ALTER TABLE `search`
  MODIFY `search_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
--
