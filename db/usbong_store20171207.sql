...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2017 at 08:14 AM
...
(6, 'Comics', 195),
(7, 'Manga', 144),
(8, 'Toys & Collectibles', 192),
(9, 'Textbooks', 154),
(10, 'Children\'s', 449),
(11, 'Food', 229),
(12, 'Miscellaneous', 187);
...
--
ALTER TABLE `product`
  MODIFY `product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=377;
--
...
--
ALTER TABLE `search`
  MODIFY `search_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;
--
