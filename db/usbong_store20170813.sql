...
(9, 1, 2, 'Siddhartha', 300, 'English', 'Hermann Hesse', NULL, 'Used - Very Good', NULL, 'Paperback', 1, '', 'This story relates the transitions a person undertook to achieve the state of everlasting peace. He first lived the life of a scholar, and then became an ascetic, and then a merchant, and then a boatman. I found it particularly interesting to learn how an ascetic could become a merchant. As it turns out, having the ability to read and write, as well as the patience to wait and fast, instead of having to seek any kind of work due to being driven by hunger, proved useful to this transition. Another key idea that I got from the book is that there are things that cannot be taught in words, but must truly be experienced for another person to understand.', NULL),
...
(36, 2, 6, 'ACTION COMICS 1-52 (complete set)', 8000, 'English', NULL, NULL, 'new, 1-52 + extras, VF-NM', NULL, 'Paperback', 1, NULL, NULL, NULL),
(37, 2, 6, 'Silver Surfer vol 1 (complete set)', 32000, 'English', NULL, NULL, 'VG-F', NULL, 'Paperback', 1, NULL, '<br>\r\n1-18 (Complete)', NULL),
(38, 2, 6, 'Batman Superman set', 3000, 'English', NULL, NULL, 'VF-NM', NULL, 'Paperback', 1, NULL, '<br>1-31, annual 1-2, future\'s end 1, missing issue 32', 0),
(39, 2, 6, 'ULTIMATE FALLOUT set', 1800, 'English', NULL, NULL, 'VF-NM', NULL, 'Paperback', 1, NULL, 'Ultimate Fallout 1-6<br>\r\nIssue 4 1st appearance Miles Morales<br>\r\nDeath of Spider-man 2nd print', NULL),
(40, 2, 6, 'KLAUS boom studios', 1200, 'English', NULL, NULL, 'complete set 1-7, VF-NM', NULL, NULL, 1, NULL, NULL, NULL),
(41, 2, 6, 'Empire of the Dead', 1500, 'English', NULL, NULL, 'VF', NULL, 'Paperback', 1, NULL, '<br>\r\nComplete 1st arc, 1-5', NULL),
(42, 2, 6, 'Fairest (complete set)', 4000, 'English', NULL, NULL, 'VF', NULL, 'Paperback', 1, NULL, NULL, NULL),
(43, 2, 6, 'Batman and Robin New 52 set', 6000, 'English', NULL, NULL, 'VF-NM', NULL, 'Paperback', 1, NULL, '<br>Complete set of Batman and Robin new 52', NULL),
...
(50, 1, 9, 'shimbun de manabu nihongo (with CDs)', 1900, 'Japanese', 'Mizutani Osamu et al.', NULL, 'New', NULL, 'Paperback', 2, NULL, NULL, NULL),
(51, 1, 9, 'kanzen masta- 2kyuu', 910, 'Japanese', '3A Corporation', NULL, 'New', NULL, 'Paperback', 2, NULL, NULL, NULL),
(52, 1, 9, 'kanzen masta- 1kyuu', 910, 'Japanese', '3A Corporation', NULL, 'New', NULL, 'Paperback', 2, NULL, NULL, NULL),
(53, 1, 9, 'kanji look and learn', 950, 'Japanese', 'Eri Banno et al. (The Japan Times)', NULL, 'New', NULL, 'Paperback', 1, NULL, NULL, NULL),
(54, 1, 9, 'genki II 2nd ed (with CD)', 2650, 'Japanese', 'Eri Banno et al. (The Japan Times)', NULL, 'New', NULL, 'Paperback', 2, NULL, NULL, NULL),
(55, 1, 9, 'genki I 2nd ed (with CD)', 2650, 'Japanese', 'Eri Banno et al. (The Japan Times)', NULL, 'New', NULL, 'Paperback', 2, NULL, NULL, NULL),
(56, 1, 9, 'erin (with DVD) vol 3', 1820, 'Japanese', 'The Japan Foundation', NULL, 'New', NULL, 'Paperback', 2, NULL, NULL, NULL),
(57, 1, 9, 'erin (with DVD) vol 2', 1820, 'Japanese', 'The Japan Foundation', NULL, 'New', NULL, 'Paperback', 2, NULL, NULL, NULL),
(58, 1, 9, 'erin (with DVD) vol 1', 1820, 'Japanese', 'The Japan Foundation', NULL, 'New', NULL, 'Paperback', 2, NULL, NULL, NULL),
...
(106, 3, 10, 'Hating Kapatid', 260, 'Filipino/English', 'Raissa Rivera Falgui/Fran Alvarez', 'Adarna House, Inc.', 'New', NULL, 'Paperback', 99, NULL, 'Story by Raissa Rivera Falgui<br>\r\nIllustrations by Fran Alvarez<br>\r\n<br>\r\nKuya and I always share food. But why is his share always bigger? Is this what fair share means?\r\n<br>\r\nHati kami ni Kuya sa anumang pagkain. Pero bakit palaging mas marami at mas malaki ang napupunta sa kaniya? Ganito ba talaga ang hating kapatid?\r\n<br><br>\r\n2014 Best Read for Kids, 3rd National Children’s Book Awards', 32),
(107, 3, 10, 'Kung Linggo', 260, 'Filipino', 'Virgilio S. Almario/Abi Goy', 'Adarna House, Inc.', 'New', NULL, 'Paperback', 99, NULL, '"Kung Linggo, nag-iimbita ako ng tigre..."\r\n<br><br>\r\nNaglalaman ang librong ito ng tula tungkol sa mga pambihirang pangyayari tuwing kasama ng isang bata ang kaniyang pang-Linggong kalaro.', 32),
(108, 3, 10, 'Pag-abot ni Kolor sa Lungsod', 260, 'Cebuano/Filipino', 'Susan Dela Rosa Aragon', 'Adarna House, Inc.', 'New', NULL, 'Paperback', 99, 'Susan Dela Rosa Aragon', 'Kaniadto hugaw ug subo ang lungsod sa Abog. Tapolan man god manglimpiyo ang mga tawo dinhi. Nausab lang ang tanan dihang miabot sa ilang dapit ang usa ka mamimintal nga subling gahatag og kolor sa palibot.\r\n<br><br>\r\nAdditional Information:\r\n<br>\r\nHinubad sa Cebuano ni Richel Dorotan ug Dr. Erlinda K. Alburo', 32),
(109, 3, 10, 'Si Ambongan', 260, 'Cebuano/Filipino', 'Lamberto Antonio/J.B. dela Peña', 'Adarna House, Inc.', 'New', NULL, 'Paperback', 99, NULL, 'Adaptation by Lamberto Antonio<br>\r\nIllustrations by J.B. dela Peña<br>\r\n<br>\r\nKini ang sugid sa kabayanihan ni Ambongan, usa ka batang nagpuyo sa Mactan sa panahon sa pag-abot ni Magellan. Pinauyon kining sugid sa Makisig, The Little Hero of Mactan nga sinulat ni Gemma Cruz Araneta kinsa maoy nakadaog sa unang ganti sa indigay sa panulat og sigulanong pangbata.', 32),
(110, 3, 10, 'Si Diwayen, Noong Bago Dumating ang mga Espanyol', 260, 'Filipino/English', 'Augie Rivera/Paolo Lim', 'Adarna House, Inc.', 'New', NULL, 'Paperback', 99, NULL, 'Story by Augie Rivera<br>\r\nIllustrations by Paolo Lim<br>\r\n<br>\r\nLunhaw and Diwayen are friends. But their fates are just too different: Lunhaw is a princess, while Diwayen is a slave. Will Diwayen ever taste true freedom?\r\n<br><br>\r\nMagkaibigan si Lunhaw at si Diwayen. Ngunit sadyang magkaiba ang kanilang kapalaran: prinsesa si Lunhaw habang alipin naman si Diwayen. Makamit kaya ni Diwayen ang tunay na kalayaan?\r\n<br><br>\r\nAdditional Information:<br>\r\nFeatured in the Batang Historyador series are stories of the challenges, dreams, and awakening of five children from five different relevant points of Philippine history. Each story is a glimpse in the way of life and rights of the children during these periods, and a look back at the colorful past of the country.', 32),
(111, 1, 8, 'Scratchbuild Revolution Hobbymate 12th Anniversary Edition', 3500, 'English', NULL, 'USA Gundam Store', 'New', NULL, 'Paperback', 1, NULL, NULL, NULL);
INSERT INTO `product` (`product_id`, `merchant_id`, `product_type_id`, `name`, `price`, `language`, `author`, `supplier`, `description`, `image_location`, `format`, `quantity_in_stock`, `translator`, `product_overview`, `pages`) VALUES
(112, 1, 2, 'Tuesdays with Morrie', 300, 'English', 'Mitch Albom', NULL, 'Used - Acceptable', NULL, 'Paperback', 1, NULL, '"The way to get meaning into your life is to devote yourself to loving others, devote yourself to your community around you, and devote yourself to creating something that gives you purpose and meaning."', NULL),
(113, 1, 6, 'Watchmen', 500, 'English', 'Alan Moore/Dave Gibbons', NULL, 'Used - Acceptable', NULL, 'Paperback', 1, NULL, 'In the midst of a global crisis, where people and nations are in conflict with each other, how do you get everyone to resolve their differences, and be united as one community?', NULL),
(114, 1, 2, 'The Alchemist', 350, 'English', 'Paulo Coelho', NULL, 'Used - Acceptable', NULL, 'Paperback', 1, NULL, '"When a person really desires something, all the universe conspires to help that person to realize his dream..." ', NULL),
(115, 1, 2, 'Made in America', 350, 'English', 'Sam Walton/John Huey', NULL, 'Used - Acceptable', NULL, 'Paperback', 1, NULL, 'This is a book which after finishing reading, I started reading again from the beginning. It shares the story of Sam Walton and how he and his team built the retail giant, Wal-Mart. I highly recommend this book to anyone who wants to understand the retail industry and the history of its development in the American context.', NULL),
(116, 1, 2, 'Goethe\'s Faust', 400, 'German/English', 'Goethe/Walter Kaufmann', NULL, 'Used - Acceptable', NULL, 'Paperback', 1, 'Walter Kaufmann', NULL, NULL),
(117, 1, 2, 'Blink', 300, 'English', 'Malcolm Gladwell', NULL, 'Used - Acceptable', NULL, 'Paperback', 1, NULL, NULL, NULL),
(118, 1, 2, 'The Tipping Point', 300, 'English', 'Malcolm Gladwell', NULL, 'Used - Acceptable', NULL, 'Paperback', 1, NULL, NULL, NULL),
(119, 1, 8, 'The Art of Matrix', 500, 'English', NULL, NULL, 'Used - Very Good', NULL, 'Paperback', 1, NULL, NULL, NULL);
...
--
ALTER TABLE `merchant_product_type`
  MODIFY `merchant_product_type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
