...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2017 at 02:02 PM
...
(123, 4, 11, 'Hondashi 1kg', 870, NULL, 'Japanese/Mandarin', NULL, NULL, 'New', NULL, NULL, 1, NULL, 'This is a necessary ingredient for many Japanese cuisines.', NULL);
...
--
ALTER TABLE `merchant_product_type`
  MODIFY `merchant_product_type_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
