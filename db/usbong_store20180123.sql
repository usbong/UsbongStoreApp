...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 23, 2018 at 02:02 AM
...
INSERT INTO `contact_case_type` (`contact_case_type_id`, `contact_case_type_name`) VALUES
(1, 'General feedback, no need to reply'),
(2, 'Need help with an issue'),
(3, 'Need help with software development');
...
(1, 'abc', 'def', 'usbong.ph@gmail.com', '$2y$10$sJ172qJOmDLBy60.nhp81OoDBQzSmi/aHcvJxJSQh5IJfx844Ec6i', '1234567', '2 E. Rodriguez Ave. Sto. Niño', 'Marikina City', 'Philippines', 1800, 0, 1, 0, '2018-01-22 15:01:59', '2018-01-21 14:47:31'),
...
(5, 'A', 'Z', 'learn@usbong.ph', '$2y$10$OHtrmYEeLXs5npFy5oBXue4YxA.PN3bLSHBMYaPy67h04w9hIDaoG', NULL, NULL, NULL, NULL, NULL, 0, 0, 1, '2017-12-27 19:05:43', '2017-12-27 19:05:58'),
...
ALTER TABLE `contact_case`
  ...
  ADD KEY `customer_id` (`customer_id`),
  ADD KEY `contact_type_id` (`contact_case_type_id`);

--
-- Indexes for table `contact_case_type`
--
ALTER TABLE `contact_case_type`
  ADD PRIMARY KEY (`contact_case_type_id`);
...
--
ALTER TABLE `contact_case`
  MODIFY `contact_case_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `contact_case_type`
--
ALTER TABLE `contact_case_type`
  MODIFY `contact_case_type_id` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `product`
  MODIFY `product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=429;
--
...
--
-- Constraints for table `contact_case`
--
ALTER TABLE `contact_case`
  ADD CONSTRAINT `contact_case_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `customer` (`customer_id`),
  ADD CONSTRAINT `contact_case_ibfk_2` FOREIGN KEY (`contact_case_type_id`) REFERENCES `contact_case_type` (`contact_case_type_id`);
