...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2017 at 10:03 AM
...
(384, 1, 2, 'Bridge to Terabithia', 300, NULL, 'English', 'Katherine Paterson', NULL, 'Used - Acceptable', NULL, 'Paperback', 1, NULL, NULL, NULL, 0, 0),
...
--
ALTER TABLE `product`
  MODIFY `product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=389;
--
