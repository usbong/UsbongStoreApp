...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2017 at 01:41 PM
...
(1, 'abc', 'def', 'usbong.ph@gmail.com', '$2y$10$.XKiIckqlnoaBSe180NEm.TRUOwvCzbNInkOey86YC5bTzPZqI8a.', NULL, NULL, NULL, NULL, NULL, 0, 1);
...
(5, 1, 2, 'The Last Lecture', 400, 'English', 'Randy Pausch et al.', NULL, 'Used - Acceptable', NULL, 'Paperback', 1, '', 'While the \"Last Lecture\" doesn\'t necessarily mean that it\'s a professor\'s last lecture, and is simply a way for senior professors at Carnegie Mellon University to share wisdom to younger students and faculty, for Randy Pausch, it really was somewhat of a last lecture, because he was already grappling with pancreatic cancer and his chance of survival was low. This book offers his insights about living.'),
...
(70, 1, 2, 'Banker to the Poor', 400, 'English', 'Muhammad Yunus', NULL, 'Used - Acceptable', NULL, 'Paperback', 1, NULL, 'The author has said: \"Who has given the ultimate verdict that people are motivated only by money--that the desire to do great things for the world can\'t be just as powerful a driving force in human behavior?\"'),
...
(79, 3, 10, 'Noong Unang Panahon', 260, 'Filipino/English', ' Rafaelita Valera/Ghani Madueño', 'Adarna House, Inc.', 'New', NULL, 'Paperback', 99, NULL, 'Story by Rafaelita S. Valera. Illustrations by Ghani Madueño. How was the world created? Where did man come from? Read three legends, from the Samal, Ifugaw, and Tagalog and Visayan, that explain the origins of the world and mankind. Paano nilikha ang mundo? Saan nanggaling ang tao? Basahin ang tatlong alamat, mula sa...'),
(80, 3, 10, 'Si Lurat, Kidhat, Pirok, ug Piyong', 260, 'Filipino/Cebuano', ' Virgilio S. Almario/Albert Gamos', 'Adarna House, Inc.', 'New', NULL, 'Paperback', 99, NULL, 'Story by Virgilio S. Almario. Illustrations by Albert Gamos. Once, four fishermen rowed their boat in a glass of water in search of a bright star. They were Open, Wink, Blink, and Close. Follow their exciting adventure as they go after their star. Diha kadto’y upat ka mangingisda nga namangka sa usa ka...'),
(81, 3, 10, 'Can We Live Without Trees', 310, 'English', 'May Tobias-Papa/Fran Alvarez', 'Adarna House, Inc.', 'New', NULL, 'Paperback', 99, NULL, 'Text by May Tobias-Papa. Illustrations by Fran Alvarez. Here is a reference book about how important trees are to humans and all living things, how biologically diverse the Philippines is, and how we can help save our forests. Find out whether we can really live without trees. Narito ang isang sangguniang tungkol sa...');
