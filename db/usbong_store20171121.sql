...
(1, 'abc', 'def', 'usbong.ph@gmail.com', '$2y$10$K4WAPR0gPya8C2XsM1VaYeH1EtmHjCNvIfG2tiTWRLoF73i5Z9poS', 1234567, '2 E. Rodriguez Ave. Sto. Niño', 'Marikina City', 'Philippines', 1800, 0, 1, 0, '2017-11-17 17:18:47', '2017-11-17 19:21:48'),
...
(74, 1, 2, 'John L Gokongwei Jr', 500, NULL, 'English', 'Marites Khanser', NULL, 'Used - Acceptable', NULL, 'Paperback', 0, NULL, 'It was interesting for me to discover the life story of Mr. John Gokongwei Jr, and how he was able to build an empire from the ground-up. Moreover, a key data provided in the book is that the common business sectors of the top 3 Philippine Listed Holding Firms include: 1) Banking and Finance, 2) Hotels, Malls and Apartments, 3) Manufacturing, and 4) Real Estate and Property Development.', NULL, 0, 0),
(75, 1, 2, 'The Millionaire Next Door', 400, NULL, 'English', 'Thomas Stanley/William Danko', NULL, 'Used - Acceptable', NULL, 'Paperback', 5, NULL, 'Along with \"The Richest Man in Babylon\", this is a book that I often find myself rereading and rereading. A key idea from the book is the importance of frugality. Moreover, for a family to become financially independent, the wife has to be thriftier than her already thrifty husband.  ', NULL, 0, 0),
...
(231, 1, 2, 'Letters to a Young Poet', 270, NULL, 'English', 'Rainer Maria Rilke/Stephen Mitchell', NULL, 'Used - Good', NULL, 'Paperback', 1, 'Stephen Mitchell', NULL, NULL, 0, 0),
...
(274, 1, 2, 'A Small Treatise on the Great Virtues', 450, NULL, 'English', 'André Comte-Sponville', NULL, 'Used - Good', NULL, 'Paperback', 1, NULL, NULL, NULL, 0, 1),
...
(325, 1, 2, 'Zen in the Art of Archery', 400, NULL, 'English', 'Eugen Herrigel', NULL, 'Used - Good', '', 'Paperback', 1, NULL, NULL, NULL, 0, 0),
(326, 1, 2, 'The Pixar Touch', 400, NULL, 'English', 'David Price', NULL, 'Used - Good', NULL, 'Hardcover', 1, NULL, NULL, NULL, 0, 0),
...
(350, 1, 10, 'Sesame Street', 240, NULL, 'English', 'Sesame Workshop', NULL, 'Used - Very Good', NULL, 'Paperback', 1, NULL, NULL, NULL, 0, 0),
...
(353, 1, 2, 'for one more day', 300, NULL, 'English', 'Mitch Albom', NULL, 'Used - Acceptable', NULL, 'Paperback', 1, NULL, 'I no longer remember the story, \"for one more day\", but I do recall crying after finishing the book.', NULL, 0, 0);
...
(6, 'Comics', 181),
(7, 'Manga', 127),
(8, 'Toys & Collectibles', 167),
(9, 'Textbooks', 144),
(10, 'Children\'s', 411),
(11, 'Food', 205),
(12, 'Miscellaneous', 178);
