...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 29, 2017 at 06:27 AM
...
(228, 4, 11, 'Rebisco Strawberry Cream-Filled Cracker Sandwich 10x32g packs', 132, NULL, 'English', NULL, NULL, 'New', NULL, NULL, 99, NULL, NULL, NULL, 0),
...
(230, 1, 2, 'Einstein The Life and Times', 400, NULL, 'English', 'Ronald Clark', NULL, 'Used - Acceptable', NULL, 'Paperback', 1, NULL, NULL, NULL, 0),
...
(251, 1, 2, 'Wooden', 400, NULL, 'English', 'John Wooden/Steve Jamison', NULL, 'Used - Good', NULL, 'Hardcover', 1, NULL, NULL, NULL, 0),
...
--
ALTER TABLE `customer_order`
  MODIFY `customer_order_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `product`
  MODIFY `product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=256;
--
